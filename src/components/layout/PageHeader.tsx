...
export const PageHeader = ({ title, right }: { title: string; right?: React.ReactNode }) => {
  ...
  return (
    <header className="sticky top-0 z-30 px-4 h-14 flex items-center gap-3 bg-background/60 backdrop-blur-2xl supports-[backdrop-filter]:bg-background/40 border-b border-border/60">
