...
import { Shield, LayoutDashboard, Inbox, Gavel, BookOpen } from "lucide-react";
import { cn } from "@/lib/utils";

const tabs = [
  { to: "/admin-os/trust-safety", label: "Dashboard", icon: LayoutDashboard, end: true },
  { to: "/admin-os/trust-safety/queue", label: "Case Queue", icon: Inbox },
  { to: "/admin-os/trust-safety/appeals", label: "Appeals", icon: Gavel },
  { to: "/admin-os/trust-safety/policies", label: "Policies", icon: BookOpen },
];

const TrustSafetyShell = () => {
...
export default TrustSafetyShell;
