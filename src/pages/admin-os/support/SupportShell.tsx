...
import { LifeBuoy, LayoutDashboard, Inbox, Timer, BarChart3 } from "lucide-react";
import { cn } from "@/lib/utils";

const tabs = [
  { to: "/admin-os/support", label: "Dashboard", icon: LayoutDashboard, end: true },
  { to: "/admin-os/support/queue", label: "Ticket Queue", icon: Inbox },
  { to: "/admin-os/support/sla", label: "SLA", icon: Timer },
  { to: "/admin-os/support/analytics", label: "Analytics", icon: BarChart3 },
];
